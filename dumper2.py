    ...
    def asana_grabby():
      ...
      with open('%s_%s_tixdata.csv' % (project_name,run_date), mode='w', newline='') as data_file:
          ...
          for task in tasks:
              ...
              try:
                  urgency_note = task_notes['custom_fields']
                  print(task_data)
                  print("--------------")
                  time.wait(30)
                  print(task_notes)
                  ...
                  if 'none' not in completed_date:
                      ...
                      if 'none' not in responded_date:
                          ...
                          if isinstance(urgency_note, str):
                              if 'Standard Request' in urgency_note:
                              ...
                              if 'Low Priority/Suggestion' in urgency_note:
                                  if 'none' not in completed_time:
                                      low_average_close = standard_average_close.append(completed_time)
                                      low_average_response = standard_average_response.append(response_time)
                              if 'Urgent' in urgency_note:
                                  if 'none' not in completed_time:
                                      urgent_average_close = standard_average_close.append(completed_time)
                                      urgent_average_response = standard_average_response.append(response_time)
