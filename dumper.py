                  ...
                  if 'none' not in completed_date:
                      ...
                      if 'Normal' in urgency_note:
                          if 'none' not in completed_time:
                              standard_average_close_data.append(completed_time)
                              standard_average_response_data.append(response_time)
                      if 'LowPri' in urgency_note:
                          if 'none' not in completed_time:
                              low_average_close_data.append(completed_time)
                              low_average_response_data.append(response_time)
                      if 'Urgent' in urgency_note:
                          if 'none' not in completed_time:
                              urgent_average_close_data.append(completed_time)
                              urgent_average_response_data.append(response_time)
